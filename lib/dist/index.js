...
function Accordion({ children, className }) {
  ...
  const length = import_react4.Children.count(children);
...
var AccordionItemBody = ({ children, className }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className, style: { maxHeight: isOpen ? "5000px" : "0px", overflow: "hidden" }, children });
};
