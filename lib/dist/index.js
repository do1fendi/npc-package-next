...
function Carousel({ children, speed = 0.3, auto, interval = 3e3, slidesToShow = 1 }) {
  ...
  const sliderChild = import_react2.default.Children.toArray(children).find(
    (child) => import_react2.default.isValidElement(child) && child.type === Carousel.Slider
  );
  const totalSlides = sliderChild ? Math.ceil(import_react2.default.Children.count(sliderChild.props.children) / slidesToShow) : 0;
  const prevSlide = () => {
    ...
    CarouselContext.Provider,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "div",
        {
          ...
          children: import_react2.default.Children.map(
            children,
...
Carousel.Slider = function Slider({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: `${100 / (ctx.totalSlides + 2)}%`, flexShrink: 0, display: "flex" }, children: groupedSlides[ctx.totalSlides - 1].map((slide, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: `${100 / ctx.slidesToShow}%`, flexShrink: 0 }, children: slide }, i)) }),
        groupedSlides.map((group, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: `${100 / (ctx.totalSlides + 2)}%`, flexShrink: 0, display: "flex" }, children: group.map((slide, i2) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: `${100 / ctx.slidesToShow}%`, flexShrink: 0 }, children: slide }, i2)) }, i)),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: `${100 / (ctx.totalSlides + 2)}%`, flexShrink: 0, display: "flex" }, children: groupedSlides[0].map((slide, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: `${100 / ctx.slidesToShow}%`, flexShrink: 0 }, children: slide }, i)) })
      ]
    }
  );
};
